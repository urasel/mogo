 ...
 */
//Configure::write('Security.salt', '94468cf69d1a43af8e488c798d1524ac49274802');
Configure::write('Security.salt', '94468cf6r1a2s3e4l5f8e488c7r1a2s4e54ac49274802');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '10564592731roshni401667692');
...
Configure::write('defaultLanguage', 'en');
Configure::write('queryCountry', 'all');
Configure::write('Config.language', 'en');
 ...
 Configure::write('Hybridauth', array(
    ...
    "Google" => array(
        "enabled" => true,
        "keys" => array("id" => "259957126008-ghgau690g214q6nk09citk5bjk56b2ed.apps.googleusercontent.com","secret" => "Xx89RxAu_aoGYOEJAF-IQTjm"),
    ),
	"Twitter" => array(
        "enabled" => true,
	...
	"Facebook" => array(
        "enabled" => true,
        "keys" => array("id" => "1003364556417692", "secret" => "d9dd44ba0f818549b1c98f53f2cc8ab6"),
		'scope'   => 'email, user_about_me, user_birthday, user_hometown, user_website, public_profile',
