...
echo '<div class="panel-heading" style="margin-bottom:10px;"><h2 class="nino-sectionHeading">'.__('Others %s Information',$place['PlaceType']['name']).'</h2></div>';
//debug($nearbies);		
				$currentLng = $this->Session->read('Config.language');		
				echo '<div class="sectionContent"><div class="row">';
