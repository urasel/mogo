                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="address_main">
                            <div class="footer_widget_add">
								...
								<?php echo $this->Html->image('logo.png',array('url' => '/','class' => 'img-responsive3')); ?>
                           ...
                           <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 gallary_response">
								...
								<div class="footer_ul_wrapper">
									...
									<?php 
										...
										echo $this->Html->link(__('Food & Recipes'),array('plugin'=>'nodes','controller' => 'nodes', 'action' => 'view','type'=>'page','slug'=> 'aboutus','language' =>$currentLng));
										echo '</li>';
										echo '<li><i class="fa fa-caret-right" aria-hidden="true"></i>';
										echo $this->Html->link(__('Automobiles & Motorcycles'),array('plugin'=>'nodes','controller' => 'nodes', 'action' => 'view','type'=>'page','slug'=> 'terms_condition','language' =>$currentLng));
										echo '</li>';
										echo '<li><i class="fa fa-caret-right" aria-hidden="true"></i>';
										echo $this->Html->link(__('Articles'),array('plugin'=>'nodes','controller' => 'nodes', 'action' => 'view','type'=>'page','slug'=> 'privacy_policy','language' =>$currentLng));
										echo '</li>';
										echo '<li><i class="fa fa-caret-right" aria-hidden="true"></i>';
										echo $this->Html->link(__('Pharmacies'),array('plugin'=>'nodes','controller' => 'nodes', 'action' => 'view','type'=>'page','slug'=> 'privacy_policy','language' =>$currentLng));
										echo '</li>';
										?>
									</ul>
								</div>
