	...
	'children' => array(
		...
		'pointcategories' => array(
			...
			'children' => array(
				...
				'contentslugs' => array(
					'title' => __d('croogo', 'Category Slugs'),
					'url' => array(
						'admin' => true,
						'plugin' => 'information',
						'controller' => 'place_type_slugs',
						'action' => 'index',
						'Site',
					),
					'weight' => 40,
...
Croogo::mergeConfig('Wysiwyg.actions', array(
    'CountryDetails/admin_add' => array(
        array(
            'elements' => 'CountryDetailGeography',
        ),
		array(
            'elements' => 'CountryDetailHistory',
        ),
		array(
            'elements' => 'CountryDetailBnGeography',
        ),
		array(
            'elements' => 'CountryDetailBnHistory',
        ),
		array(
            'elements' => 'CountryDetailEconomicSummary',
        ),
		array(
            'elements' => 'CountryDetailBnEconomicSummary',
        ),
    ),
	'CountryDetails/admin_edit' => array(
        array(
            'elements' => 'CountryDetailGeography',
        ),
		array(
