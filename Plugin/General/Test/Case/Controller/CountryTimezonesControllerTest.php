<?php
App::uses('CountryTimezonesController', 'General.Controller');

/**
 * CountryTimezonesController Test Case
 *
 */
class CountryTimezonesControllerTest extends ControllerTestCase {
