<?php
App::uses('ProfessionalDegreesController', 'General.Controller');

/**
 * ProfessionalDegreesController Test Case
 *
 */
class ProfessionalDegreesControllerTest extends ControllerTestCase {
