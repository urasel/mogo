<?php
App::uses('CountryCapitalsController', 'General.Controller');

/**
 * CountryCapitalsController Test Case
 *
 */
class CountryCapitalsControllerTest extends ControllerTestCase {
