<?php
App::uses('CountryCurrenciesController', 'General.Controller');

/**
 * CountryCurrenciesController Test Case
 *
 */
class CountryCurrenciesControllerTest extends ControllerTestCase {
