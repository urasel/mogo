<?php
App::uses('HotelExtraFacilitiesController', 'General.Controller');

/**
 * HotelExtraFacilitiesController Test Case
 *
 */
class HotelExtraFacilitiesControllerTest extends ControllerTestCase {
