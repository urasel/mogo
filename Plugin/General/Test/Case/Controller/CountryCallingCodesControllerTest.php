<?php
App::uses('CountryCallingCodesController', 'General.Controller');

/**
 * CountryCallingCodesController Test Case
 *
 */
class CountryCallingCodesControllerTest extends ControllerTestCase {
