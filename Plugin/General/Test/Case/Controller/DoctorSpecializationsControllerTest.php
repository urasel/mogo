<?php
App::uses('DoctorSpecializationsController', 'General.Controller');

/**
 * DoctorSpecializationsController Test Case
 *
 */
class DoctorSpecializationsControllerTest extends ControllerTestCase {
