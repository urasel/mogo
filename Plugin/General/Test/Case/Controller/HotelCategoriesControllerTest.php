<?php
App::uses('HotelCategoriesController', 'General.Controller');

/**
 * HotelCategoriesController Test Case
 *
 */
class HotelCategoriesControllerTest extends ControllerTestCase {
