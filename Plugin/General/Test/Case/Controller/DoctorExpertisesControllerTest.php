<?php
App::uses('DoctorExpertisesController', 'General.Controller');

/**
 * DoctorExpertisesController Test Case
 *
 */
class DoctorExpertisesControllerTest extends ControllerTestCase {
