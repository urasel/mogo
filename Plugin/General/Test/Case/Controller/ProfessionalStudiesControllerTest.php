<?php
App::uses('ProfessionalStudiesController', 'General.Controller');

/**
 * ProfessionalStudiesController Test Case
 *
 */
class ProfessionalStudiesControllerTest extends ControllerTestCase {
