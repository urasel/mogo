<?php
App::uses('HotelRoomCategoriesController', 'General.Controller');

/**
 * HotelRoomCategoriesController Test Case
 *
 */
class HotelRoomCategoriesControllerTest extends ControllerTestCase {
