<?php
App::uses('HospitalCategoriesController', 'General.Controller');

/**
 * HospitalCategoriesController Test Case
 *
 */
class HospitalCategoriesControllerTest extends ControllerTestCase {
