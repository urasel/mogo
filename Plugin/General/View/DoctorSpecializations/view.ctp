...
<h2><?php echo __('Doctor Specialization'); ?></h2>
	<dl>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Doctor Specialization'), array('action' => 'edit', $doctorSpecialization['DoctorSpecialization']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Doctor Specialization'), array('action' => 'delete', $doctorSpecialization['DoctorSpecialization']['id']), array(), __('Are you sure you want to delete # %s?', $doctorSpecialization['DoctorSpecialization']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Doctor Specializations'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($doctorSpecialization['Doctor'])): ?>
	...
	<?php foreach ($doctorSpecialization['Doctor'] as $doctor): ?>
		<tr>
