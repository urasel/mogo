...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Sex'), array('action' => 'delete', $sex['Sex']['id']), array(), __('Are you sure you want to delete # %s?', $sex['Sex']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($sex['Doctor'] as $doctor): ?>
		<tr>
