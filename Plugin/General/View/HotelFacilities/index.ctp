<div class="hotelFacilities index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $hotelFacility['HotelFacility']['id']), array(), __('Are you sure you want to delete # %s?', $hotelFacility['HotelFacility']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
