<div class="religions index">
	...
	<tr>
		...
		<td><?php echo h($religion['Religion']['bn_name']); ?>&nbsp;</td>
		<td><?php echo h($religion['Religion']['icon']); ?>&nbsp;</td>
		<td><?php echo h($religion['Religion']['isactive']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $religion['Religion']['id']), array(), __('Are you sure you want to delete # %s?', $religion['Religion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
