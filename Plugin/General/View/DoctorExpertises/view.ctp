...
<h2><?php echo __('Doctor Expertise'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Expertise Details'); ?></dt>
		<dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Doctor Expertise'), array('action' => 'edit', $doctorExpertise['DoctorExpertise']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Doctor Expertise'), array('action' => 'delete', $doctorExpertise['DoctorExpertise']['id']), array(), __('Are you sure you want to delete # %s?', $doctorExpertise['DoctorExpertise']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Doctor Expertises'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($doctorExpertise['Doctor'])): ?>
	...
	<?php foreach ($doctorExpertise['Doctor'] as $doctor): ?>
		<tr>
