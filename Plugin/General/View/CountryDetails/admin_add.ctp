...
$this->append('tab-heading');
	echo $this->Croogo->adminTab(__d('general', 'General Information'), '#country-general');
	echo $this->Croogo->adminTab(__d('general', 'Country Detail English'), '#country-english');
	echo $this->Croogo->adminTab(__d('general', 'Country Detail Bangla'), '#country-bangla');
	echo $this->Croogo->adminTabs();
$this->end();

$this->append('tab-content');
	echo $this->Html->tabStart('country-general');
	...
	echo $this->Html->tabStart('country-english');
	...
	echo $this->Html->tabStart('country-bangla');
