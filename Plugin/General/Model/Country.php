 ...
 * @property HolyPlace $HolyPlace
 * @property Hotel $Hotel
 * @property Place $Place
 * @property Point $Point
 * @property PointsBackup $PointsBackup
 * @property Postcode $Postcode
 * @property Postofficestwo $Postofficestwo
 * @property Profile $Profile
 * @property School $School
 * @property Zone $Zone
 */
class Country extends GeneralAppModel {
