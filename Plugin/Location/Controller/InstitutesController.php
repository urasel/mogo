 ...
 */
class InstitutesController extends LocationAppController {
 ...
 */
	public function view($id = null) {
		if (!$this->Institute->exists($id)) {
			throw new NotFoundException(__d('croogo', 'Invalid %s', __d('location', 'institute')));
		}
	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Institute->saveAssociated($this->request->data)) {
				$this->Session->setFlash(__d('croogo', '%s has been saved', __d('location', 'institute')), 'default', array('class' => 'success'));
				...
				$this->Session->setFlash(__d('croogo', '%s could not be saved. Please, try again.', __d('location', 'institute')), 'default', array('class' => 'error'));
			}
		}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Institute->delete()) {
			$this->Session->setFlash(__d('croogo', '%s deleted', __d('location', 'Institute')), 'default', array('class' => 'success'));
			return $this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__d('croogo', '%s was not deleted', __d('location', 'Institute')), 'default', array('class' => 'error'));
		return $this->redirect(array('action' => 'index'));
	}
