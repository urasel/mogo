<?php
App::uses('InstituteImagesController', 'Location.Controller');

/**
 * InstituteImagesController Test Case
 *
 */
class InstituteImagesControllerTest extends ControllerTestCase {
