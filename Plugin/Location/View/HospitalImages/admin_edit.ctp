...
if ($this->action == 'admin_edit') {
	...
	$this->viewVars['title_for_layout'] = __d('location', 'Hospital Images') . ': ' . $this->request->data['HospitalImage']['id'];
} else {
...
$this->append('tab-heading');
	echo $this->Croogo->adminTab(__d('location', 'Hospital Image'), '#hospital-image');
