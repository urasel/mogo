 ...
 */
class HospitalsController extends InformationAppController {
 ...
 */
	public function view($id = null) {
		if (!$this->Hospital->exists($id)) {
			throw new NotFoundException(__d('croogo', 'Invalid %s', __d('information', 'hospital')));
		}
	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Hospital->saveAssociated($this->request->data)) {
				$this->Session->setFlash(__d('croogo', '%s has been saved', __d('information', 'hospital')), 'default', array('class' => 'success'));
				...
				$this->Session->setFlash(__d('croogo', '%s could not be saved. Please, try again.', __d('information', 'hospital')), 'default', array('class' => 'error'));
			}
		}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Hospital->delete()) {
			$this->Session->setFlash(__d('croogo', '%s deleted', __d('information', 'Hospital')), 'default', array('class' => 'success'));
			return $this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__d('croogo', '%s was not deleted', __d('information', 'Hospital')), 'default', array('class' => 'error'));
		return $this->redirect(array('action' => 'index'));
	}
