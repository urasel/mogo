<?php
App::uses('SubscriberListsController', 'Information.Controller');

/**
 * SubscriberListsController Test Case
 *
 */
class SubscriberListsControllerTest extends ControllerTestCase {
