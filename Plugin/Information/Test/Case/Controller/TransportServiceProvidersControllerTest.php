<?php
App::uses('TransportServiceProvidersController', 'Information.Controller');

/**
 * TransportServiceProvidersController Test Case
 *
 */
class TransportServiceProvidersControllerTest extends ControllerTestCase {
