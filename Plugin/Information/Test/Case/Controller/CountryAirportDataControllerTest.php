<?php
App::uses('CountryAirportDataController', 'Information.Controller');

/**
 * CountryAirportDataController Test Case
 *
 */
class CountryAirportDataControllerTest extends ControllerTestCase {
