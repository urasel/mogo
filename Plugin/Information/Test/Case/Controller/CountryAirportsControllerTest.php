<?php
App::uses('CountryAirportsController', 'Information.Controller');

/**
 * CountryAirportsController Test Case
 *
 */
class CountryAirportsControllerTest extends ControllerTestCase {
