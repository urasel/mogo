<?php
App::uses('TransportTypesController', 'Information.Controller');

/**
 * TransportTypesController Test Case
 *
 */
class TransportTypesControllerTest extends ControllerTestCase {
