<?php
App::uses('HospitalImagesController', 'Information.Controller');

/**
 * HospitalImagesController Test Case
 *
 */
class HospitalImagesControllerTest extends ControllerTestCase {
