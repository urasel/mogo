<?php
App::uses('TransportRoutesController', 'Information.Controller');

/**
 * TransportRoutesController Test Case
 *
 */
class TransportRoutesControllerTest extends ControllerTestCase {
