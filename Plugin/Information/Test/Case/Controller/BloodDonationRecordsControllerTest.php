<?php
App::uses('BloodDonationRecordsController', 'Information.Controller');

/**
 * BloodDonationRecordsController Test Case
 *
 */
class BloodDonationRecordsControllerTest extends ControllerTestCase {
