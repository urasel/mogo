<?php
App::uses('MotorcycleSpecificationsController', 'Information.Controller');

/**
 * MotorcycleSpecificationsController Test Case
 *
 */
class MotorcycleSpecificationsControllerTest extends ControllerTestCase {
