<?php
App::uses('MotorcycleModelsController', 'Information.Controller');

/**
 * MotorcycleModelsController Test Case
 *
 */
class MotorcycleModelsControllerTest extends ControllerTestCase {
