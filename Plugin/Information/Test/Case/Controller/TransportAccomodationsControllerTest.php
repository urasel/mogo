<?php
App::uses('TransportAccomodationsController', 'Information.Controller');

/**
 * TransportAccomodationsController Test Case
 *
 */
class TransportAccomodationsControllerTest extends ControllerTestCase {
