<?php
App::uses('TransportGalleriesController', 'Information.Controller');

/**
 * TransportGalleriesController Test Case
 *
 */
class TransportGalleriesControllerTest extends ControllerTestCase {
