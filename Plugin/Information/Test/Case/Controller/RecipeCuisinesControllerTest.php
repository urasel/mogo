<?php
App::uses('RecipeCuisinesController', 'Information.Controller');

/**
 * RecipeCuisinesController Test Case
 */
class RecipeCuisinesControllerTest extends ControllerTestCase {
