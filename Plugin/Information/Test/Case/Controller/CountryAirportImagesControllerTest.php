<?php
App::uses('CountryAirportImagesController', 'Information.Controller');

/**
 * CountryAirportImagesController Test Case
 *
 */
class CountryAirportImagesControllerTest extends ControllerTestCase {
