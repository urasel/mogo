<?php
App::uses('PlaceTypeSlugsController', 'Information.Controller');

/**
 * PlaceTypeSlugsController Test Case
 *
 */
class PlaceTypeSlugsControllerTest extends ControllerTestCase {
