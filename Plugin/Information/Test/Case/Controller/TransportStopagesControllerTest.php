<?php
App::uses('TransportStopagesController', 'Information.Controller');

/**
 * TransportStopagesController Test Case
 *
 */
class TransportStopagesControllerTest extends ControllerTestCase {
