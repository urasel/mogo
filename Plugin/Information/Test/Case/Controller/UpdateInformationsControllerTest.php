<?php
App::uses('UpdateInformationsController', 'Information.Controller');

/**
 * UpdateInformationsController Test Case
 *
 */
class UpdateInformationsControllerTest extends ControllerTestCase {
