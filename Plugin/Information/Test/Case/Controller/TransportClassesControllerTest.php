<?php
App::uses('TransportClassesController', 'Information.Controller');

/**
 * TransportClassesController Test Case
 *
 */
class TransportClassesControllerTest extends ControllerTestCase {
