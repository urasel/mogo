<?php
App::uses('LocationImagesController', 'Information.Controller');

/**
 * LocationImagesController Test Case
 *
 */
class LocationImagesControllerTest extends ControllerTestCase {
