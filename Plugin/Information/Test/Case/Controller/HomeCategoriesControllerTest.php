<?php
App::uses('HomeCategoriesController', 'Information.Controller');

/**
 * HomeCategoriesController Test Case
 *
 */
class HomeCategoriesControllerTest extends ControllerTestCase {
