<?php
App::uses('BloodNewsDetailsController', 'Information.Controller');

/**
 * BloodNewsDetailsController Test Case
 *
 */
class BloodNewsDetailsControllerTest extends ControllerTestCase {
