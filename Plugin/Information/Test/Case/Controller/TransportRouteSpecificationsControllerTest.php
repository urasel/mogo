<?php
App::uses('TransportRouteSpecificationsController', 'Information.Controller');

/**
 * TransportRouteSpecificationsController Test Case
 */
class TransportRouteSpecificationsControllerTest extends ControllerTestCase {
