...
?>
	<div class="row placeview">
		...
		<div class="col-md-8 col-md-push-4">
			...
			echo '<div class="col-sm-12 col-md-12 col-xs-12 zeropadding"><h1 class="posttitle">'.$place['Point']['name'].' details fact<span class="admin_edit_link">'.$adminLink.'</span></h1></div>'; 
			?>
			<?php 
			...
			echo '<div class="col-sm-12 col-md-12 col-xs-12 zeropadding"><p>'.$address.$place['Country']['name'].' '.'</p></div></div>'; ?>
