...
function loadPlaces(a,b,c){$("#placeHolder").html("");$.ajax({dataType:"html",type:"POST",evalScripts:!0,url:"<?php echo Router::url(array('plugin'=> 'information','controller'=>'siteactions','action'=>'findplace'));?>",data:{lat:a,lng:b,address:c},success:function(a,b){$("#placeHolder").removeClass("ajax-loader");$("#placeHolder").html(a)}})}
