	...
	echo $this->Html->tabStart('transport-route');
		...
		echo '<div class="routeContainer">';
			...
			echo '<div class="routePart">';
				...
				echo $this->Form->input('TransportRoute.RouteFromId',array(
					'id'=>'RouteFromId',
					'type'=>'hidden',
					'name' => 'data[TransportRoute][RouteFromId][]',
				));
				echo $this->Form->input('TransportRoute.RouteToId',array(
					'id'=>'RouteToId',
					'type'=>'hidden',
					'name' => 'data[TransportRoute][RouteToId][]',
				));
