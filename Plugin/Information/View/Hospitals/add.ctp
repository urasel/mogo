...
if ($this->action == 'admin_edit') {
	...
	$this->viewVars['title_for_layout'] = __d('information', 'Hospitals') . ': ' . $this->request->data['Hospital']['name'];
} else {
...
$this->append('tab-heading');
	echo $this->Croogo->adminTab(__d('information', 'Hospital'), '#hospital');
...
$this->append('tab-content');
	...
	echo $this->Html->tabStart('hospital');
		...
		echo $this->Form->input('hospital_category_id', array(
			'label' =>  __d('information', 'Hospital Category'),
		));
		echo $this->Form->input('speciality', array(
			'label' =>  __d('information', 'Speciality'),
		));
