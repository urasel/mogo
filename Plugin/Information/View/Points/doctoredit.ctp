...
<?php echo $this->Form->create('Point',array('type'=>'file')); ?>
	...
	<?php
		...
		echo '<div class="panel-body">';
		echo $this->Form->input('Doctor.id');
		echo $this->Form->input('Doctor.name', array('class'=>'form-control','label'=>'Doctor Name','tabindex'=> "6"));
		$selectedHospital = json_decode($this->request->data['Doctor']['hospitalids']);
		echo $this->Form->input('Doctor.hospital_id', array('class'=>'tokenize-sample','selected'=>$selectedHospital,'id'=>'serving','multiple'=>'multiple','label'=>'Seving Hospital Name','tabindex'=> "7"));
		
		echo $this->Form->input('Doctor.designation', array('class'=>'form-control','label'=>'Current Post','tabindex'=> "7"));
		echo $this->Form->input('Doctor.dob', array('class'=>'form-control','label'=>'Date of Birth','tabindex'=> "7"));
		...
		$selectedExpertise = json_decode($this->request->data['Doctor']['expertiseids']);
		//debug($selectedExpertise);
		echo $this->Form->input('Doctor.doctor_specialization_id', array('class'=>'form-control','label'=>'Specialized','tabindex'=> "8"));
		echo $this->Form->input('Doctor.doctor_expertise_id', array('class'=>'tokenize-sample','selected'=>$selectedExpertise,'id'=>'expertise','multiple'=>'multiple','label'=>'Expertise','tabindex'=> "8"));
		...
		echo $this->Form->input('Doctor.image',array('type'=>'hidden'));
		$imglink = "doctors/".$this->data['Doctor']['image'];
		echo $this->Html->image($imglink,array('class' =>'snapimageimg'));
		echo $this->Form->input('Doctor.newimage', array('type'=>'file','placeholder'=>'Profile Image','tabindex'=> "9"));
