...
$this->append('tab-content');
	...
	echo $this->Html->tabStart('bangla');
				echo $this->Form->unlockField('Topic.bn.languageid');
	...
	echo $this->Html->tabStart('english');
				echo $this->Form->unlockField('Topic.en.languageid');
				...
				echo $this->Form->input('Topic.en.details', array('type'=>'textarea','label'=>'Details  [For Language Change Type ctrl+ g]','tabindex'=> "3",'class'=>'input-block-level'));
	...
	echo $this->Html->tabStart('point');
		...
		echo $this->Form->unlockField('Topic.image');
		echo $this->Form->input('Topic.image', array('type'=>'file','id'=>'image_file','onchange'=>'fileSelectHandler()'));
