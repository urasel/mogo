...
$this->append('form-start', $this->Form->create('Point',array('type'=>'file','url' => array('action' =>'transportStopageedit') )));
...
$this->append('tab-content');
	...
	echo $this->Html->tabStart('place');
		...
		if(!empty($this->request->data[$dataClass]['logo'])){
			...
			echo $this->Html->image('transportStopage/logo/medium/'.$this->request->data[$dataClass]['logo']);
		}
