...
$this->append('form-start', $this->Form->create('Point',array('type'=>'file','url' => array('action' =>'locationedit') )));
...
$this->append('tab-content');
	...
	echo $this->Html->tabStart('place');
		...
		echo $this->Form->input($dataClass.'.area1', array(
			'label' =>  __d('information', 'Area1'),
		));
		echo $this->Form->input($dataClass.'.area2', array(
			'label' =>  __d('information', 'Area2'),
		));
		echo $this->Form->input($dataClass.'.area3', array(
			'label' =>  __d('information', 'Area3'),
		));
		echo $this->Form->input($dataClass.'.name', array(
			'label' =>  __d('information', 'Name'),
		));
		echo $this->Form->input($dataClass.'.seo_name', array(
			'label' =>  __d('information', 'Seo Name'),
		));
		echo $this->Form->input($dataClass.'.population', array(
			'label' =>  __d('information', 'Population'),
		));
		echo $this->Form->input($dataClass.'.lat', array(
			'label' =>  __d('information', 'Lat'),
		));
		echo $this->Form->input($dataClass.'.lng', array(
			'label' =>  __d('information', 'Lng'),
		));
		echo $this->Form->input($dataClass.'.address', array(
			'label' =>  __d('information', 'Address'),
		));
		echo $this->Form->input($dataClass.'.northeast_lat', array(
			'label' =>  __d('information', 'Northeast Lat'),
		));
		echo $this->Form->input($dataClass.'.northeast_lng', array(
			'label' =>  __d('information', 'Northeast Lng'),
		));
		echo $this->Form->input($dataClass.'.southwest_lat', array(
			'label' =>  __d('information', 'Southwest Lat'),
		));
		echo $this->Form->input($dataClass.'.southwest_lng', array(
			'label' =>  __d('information', 'Southwest Lng'),
		));
		echo $this->Form->input($dataClass.'.updateflag', array(
	...
	//debug($this->data);
		if(isset($this->data[$imageClass]) && count($this->data[$imageClass]) > 0){
			foreach ($this->data[$imageClass] as $image){
				...
				$imglink = "locations/photogallery/".$image['file'];
