...
$this->append('form-start', $this->Form->create('Point',array('type'=>'file','url' => array('action' =>'transportServiceProvideredit') )));
...
$this->append('tab-content');
	...
	echo $this->Html->tabStart('place');
		...
		echo $this->Form->input($dataClass.'.head_office');	
		echo $this->Form->input($dataClass.'.bn_head_office');	
