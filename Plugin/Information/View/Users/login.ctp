...
$this->Html->addCrumb(__('InfoMap24 Login'),  '' , array('class' => 'active'));
	...
	echo '<div class="row">';
		...
		echo '<h4 class="text-center login-txt-center">Alternatively, you can log in using:</h4>'; 
		...
		*/
		...
		<div class="row">
			...
			<div class="col-xs-6 col-sm-6 col-md-6">
				...
				<?php echo $this->Html->link(__d('croogo', __('Sign Up')), array('controller' => 'users', 'action' => 'forgot'));?>
			</div>
		</div>
		<?php
		echo '</div>';
